...
namespace EdgeParty.Gameplay.Character
{
    ...
    public class CharacterMotor : MonoBehaviour
    {
        ...
        private void ApplyRotation()
        {
            ...
            {
                // We use a MUCH higher rotation speed during dash/attack to keep the body stable 
                // against the torque generated by the punching arms.
                float rotSpeed = _isOneShotActive ? 20f : 14f; 
            ...
            // If one-shot (dash/jump) is active, we force the pelvis to stay upright relative to facing direction
            // instead of following the animation's tilt/lean.
            Quaternion targetRot = _isOneShotActive 
                ? Quaternion.LookRotation(_facingDir, Vector3.up) 
                : ghostPelvis.rotation;
